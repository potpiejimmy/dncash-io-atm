...
export async function dispense(cashoutRequest: any, canCancel?: boolean): Promise<any> {
    ...
    try {
        ...
        if(!canCancel) {
            ...
            return dispense(cashoutRequest, true);
        }
    }
...
export async function sendRetract(canCancel?: boolean): Promise<any> {
